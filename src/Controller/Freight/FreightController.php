...
{
    #[Route('/', name: 'app_freight_freight_index', methods: ['GET'])]
    ...
    #[Route('/new', name: 'app_freight_freight_new', methods: ['GET', 'POST'])]
    ...
    #[Route('/{id}', name: 'app_freight_freight_show', methods: ['GET'])]
    ...
    #[Route('/{id}/edit', name: 'app_freight_freight_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/{id}', name: 'app_freight_freight_delete', methods: ['POST'])]
